...
#define WDR3500_GPIO_LED_WLAN2G		12
...
#define WDR3500_GPIO_USB_POWER		13
...
static void __init wdr3500_setup(void)
{
	...
	ath79_register_wmac(art + WDR3500_WMAC_CALDATA_OFFSET, NULL);

	ath79_init_mac(tmpmac, mac, 1);
	ap9x_pci_setup_wmac_led_pin(0, 0);
	ap91_pci_init(art + WDR3500_PCIE_CALDATA_OFFSET, NULL);
